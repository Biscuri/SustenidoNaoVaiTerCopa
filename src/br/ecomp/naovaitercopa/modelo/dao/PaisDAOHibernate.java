...
public class PaisDAOHibernate implements PaisDAO {
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.PaisDAO#adicionar(br.ecomp.naovaitercopa
	 * .modelo.Pais)
	 */
	@Override
	public void adicionar(Pais pais) {
		try {
			...
			System.err.println("Nao foi possivel inserir o pais. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.PaisDAO#atualizar(br.ecomp.naovaitercopa
	 * .modelo.Pais)
	 */
	@Override
	public void atualizar(Pais pais) {
		try {
			...
			System.err.println("Nao foi possivel atualizar o pais. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.PaisDAO#remover(br.ecomp.naovaitercopa.
	 * modelo.Pais)
	 */
	@Override
	public void remover(Pais pais) {
		try {
			...
			System.err.println("Nao foi possivel excluir o pais. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.ecomp.naovaitercopa.modelo.PaisDAO#removerTodos()
	 */
	@Override
	public void removerTodos() {
		try {
			...
			System.err.println("Nao foi possivel excluir os paiss. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.ecomp.naovaitercopa.modelo.PaisDAO#listar()
	 */
	@Override
	...
	public List<Pais> listar() {
		...
		try {
			...
			System.err.println("Nao foi possivel listar os paiss. Erro: "
					+ e.getMessage());
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.ecomp.naovaitercopa.modelo.PaisDAO#buscarPais(java.lang.String)
	 */
	@Override
	public Pais buscarPais(String nome) {
		...
		try {
			...
			Query consulta = sessao
					.createQuery("from Pais where nome = :parametro");
			...
			System.err.println("Nao foi possivel buscar o pais. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
