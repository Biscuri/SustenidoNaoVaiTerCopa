...
public class CopaDAOHibernate implements CopaDAO {
	...
	/* (non-Javadoc)
	 * @see br.ecomp.naivaitercopa.modelo.CopaDAO#adicionar(br.ecomp.naivaitercopa.modelo.Copa)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.ecomp.naivaitercopa.modelo.CopaDAO#atualizar(br.ecomp.naivaitercopa.modelo.Copa)
	 */
	@Override
	public void atualizar(Copa copa) {
		try {
			...
			System.err.println("Nao foi possivel atualizar o copa. Erro: " + e.getMessage());
		} finally {
			try {
				sessao.close();
			} catch (Throwable e) {
	...
	/* (non-Javadoc)
	 * @see br.ecomp.naivaitercopa.modelo.CopaDAO#remover(br.ecomp.naivaitercopa.modelo.Copa)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.ecomp.naivaitercopa.modelo.CopaDAO#removerTodos()
	 */
	@Override
	public void removerTodos() {
		try {
			...
			System.err.println("Nao foi possivel excluir os copas. Erro: " + e.getMessage());
		} finally {
			try {
				sessao.close();
			} catch (Throwable e) {
	...
	/* (non-Javadoc)
	 * @see br.ecomp.naivaitercopa.modelo.CopaDAO#listar()
	 */
	@Override
	...
	public List<Copa> listar() {
		...
		try {
			...
			System.err.println("Nao foi possivel listar os copas. Erro: " + e.getMessage());
	...
	public Copa buscarCopa(int ano) {
		...
		try {
			...
			System.err.println("Nao foi possivel buscar o copa. Erro: " + e.getMessage());
		} finally {
			try {
				sessao.close();
			} catch (Throwable e) {
