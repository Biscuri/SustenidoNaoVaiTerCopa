...
public class JogadorDAOHibernate implements JogadorDAO {
	 ...
	 * 
	 * @see
	 * br.ecomp.naivaitercopa.modelo.JogadorDAO#adicionar(br.ecomp.naivaitercopa
	 * .modelo.Jogador)
	 */
	@Override
	public void adicionar(Jogador jogador) {
		try {
			...
			System.err.println("Nao foi possivel inserir o jogador. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * 
	 * @see
	 * br.ecomp.naivaitercopa.modelo.JogadorDAO#atualizar(br.ecomp.naivaitercopa
	 * .modelo.Jogador)
	 */
	@Override
	public void atualizar(Jogador jogador) {
		try {
			...
			System.err.println("Nao foi possivel atualizar o jogador. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * 
	 * @see
	 * br.ecomp.naivaitercopa.modelo.JogadorDAO#remover(br.ecomp.naivaitercopa
	 * .modelo.Jogador)
	 */
	@Override
	public void remover(Jogador jogador) {
		try {
			...
			System.err.println("Nao foi possivel excluir o jogador. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	...
	public void removerTodos() {
		try {
			...
			System.err.println("Nao foi possivel excluir os jogadors. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	...
	public List<Jogador> listar() {
		...
		try {
			...
			System.err.println("Nao foi possivel listar os jogadors. Erro: "
					+ e.getMessage());
	 ...
	 * 
	 * @see
	 * br.ecomp.naivaitercopa.modelo.JogadorDAO#buscarJogador(java.lang.String,
