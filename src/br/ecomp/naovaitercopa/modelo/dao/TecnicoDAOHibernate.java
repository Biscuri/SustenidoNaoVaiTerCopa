...
public class TecnicoDAOHibernate implements TecnicoDAO {
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.TecnicoDAO#adicionar(br.ecomp.naovaitercopa
	 * .modelo.Tecnico)
	 */
	@Override
	public void adicionar(Tecnico tecnico) {
		try {
			...
			System.err.println("Nao foi possivel inserir o tecnico. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.TecnicoDAO#atualizar(br.ecomp.naovaitercopa
	 * .modelo.Tecnico)
	 */
	@Override
	public void atualizar(Tecnico tecnico) {
		try {
			...
			System.err.println("Nao foi possivel atualizar o tecnico. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.TecnicoDAO#remover(br.ecomp.naovaitercopa
	 * .modelo.Tecnico)
	 */
	@Override
	public void remover(Tecnico tecnico) {
		try {
			...
			System.err.println("Nao foi possivel excluir o tecnico. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.ecomp.naovaitercopa.modelo.TecnicoDAO#removerTodos()
	 */
	@Override
	public void removerTodos() {
		try {
			...
			System.err.println("Nao foi possivel excluir os tecnicos. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.ecomp.naovaitercopa.modelo.TecnicoDAO#listar()
	 */
	@Override
	...
	public List<Tecnico> listar() {
		...
		try {
			...
			System.err.println("Nao foi possivel listar os tecnicos. Erro: "
					+ e.getMessage());
	 ...
	 * 
	 * @see
	 * br.ecomp.naovaitercopa.modelo.TecnicoDAO#buscarTecnico(java.lang.String)
	 */
	@Override
	public Tecnico buscarTecnico(String nome) {
		...
		try {
			...
			Query consulta = sessao
					.createQuery("from Tecnico where nome = :parametro");
			...
			System.err.println("Nao foi possivel buscar o tecnico. Erro: "
					+ e.getMessage());
		} finally {
			try {
				sessao.close();
